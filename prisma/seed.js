...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        rimsSeedData.map((item) => __awaiter(this, void 0, void 0, function* () {
            yield prisma.rims.create({
                data: item
            });
        }));
        tireArray.map((item) => __awaiter(this, void 0, void 0, function* () {
            yield prisma.tire.create({
                data: item
            });
        }));
    });
